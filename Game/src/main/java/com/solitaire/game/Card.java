...
public class Card extends JLabel{
    ...
    public void turnFaceUp(){
        faceDown = false;
        try{
            image = ImageIO.read(new File("src/main/resources/"+ rank.getRankString() + "_" + suit.getSuitString() + ".png"));
        } catch (IOException e){
            e.printStackTrace();
        }
    ...
    public void turnFaceDown(){
        faceDown = true;
        try{
            backOfCard = ImageIO.read(new File("src/main/resources/back.png"));
        }
        catch (IOException e){
            e.printStackTrace();
        }
